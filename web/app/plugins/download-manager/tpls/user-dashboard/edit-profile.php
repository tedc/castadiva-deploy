    ...
    <div id="edit-profile-form">
        ...
        <form method="post" id="edit_profile" name="contact_form" action="" class="form">
            ...
            <div class="row">
                ...
                <div class="col-md-12 wpdm-clear"><label for="message">Description:</label><textarea class="text form-control" cols="40" rows="8" name="wpdm_profile[description]" id="message"><?php echo htmlspecialchars(stripslashes($current_user->description));?></textarea></div>
            ...
            <div class="row">
                <div class="col-md-12 wpdm-clear"><button type="submit" class="btn btn-lg btn-primary"><i class="fa fa-floppy-o"></i> &nbsp; Save Changes</button></div>
            </div>
