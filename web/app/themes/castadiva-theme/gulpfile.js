...
gulp.task('browserify', function() {
    gulp.src( path.source + 'coffee/app.coffee' , { read : false} )
        .pipe(browserify({
            transform: ['coffeeify'],
            extensions: ['.coffee']
        }))
        .pipe(rename('scripts.js'))
        .pipe(source.dest + 'js/src')
});
...
gulp.task('watch', function() {
  ...
  gulp.watch([path.source + 'javascript/**/**/**/**/*', path.dist + 'js/src/**/**/**/*'], ['jshint', 'scripts']);
  gulp.watch([path.dist + 'fonts/**/*'], ['fonts']);
  gulp.watch([path.dist + 'img/**/*'], ['images']);
