...
<?php endwhile; ?>
<?php $args = get_sub_field('prodotti'); $count_product = 0; $products = new WP_Query(array('post_type' => 'product', 'post__in' => $args)); $total_product = $products->post_count - 1; if(get_sub_field('is_carousel')) : ?>
