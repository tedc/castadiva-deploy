...
<?php if ( $has_orders ) : ?>
	...
	<div class="woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
			...
			<?php foreach ( $customer_orders->orders as $customer_order ) :
				...
				<div class="order-item">
					<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
						<p class="<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
